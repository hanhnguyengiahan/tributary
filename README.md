# 🌊 Tributary <!-- omit in toc -->

- [1. Engineering Requirements](#1-engineering-requirements)
  - [1.1. Message Lifecycle: A Simple Example](#11-message-lifecycle-a-simple-example)
  - [1.2. Message Structure](#32-message-structure)
  - [1.3. Producers](#33-producers)
    - [1.3.1. Allocation of Messages to Partitions](#131-allocation-of-messages-to-partitions)
  - [1.4. Consumer and Consumer Groups](#14-consumer-and-consumer-groups)
    - [1.4.1. Consumers](#141-consumers)
    - [1.4.2. Consumer Groups](#142-consumer-groups)
    - [1.4.3. Consumer Rebalancing](#143-consumer-rebalancing)
      - [1.4.3.1. Range Rebalancing](#1431-range-rebalancing)
      - [1.4.3.2. Round Robin Rebalancing](#1432-round-robin-rebalancing)
  - [1.5. Replay Messages](#15-replay-messages)
  - [1.6. Design Considerations](#16-design-considerations)
- [2. Interface](#2-interface)
  - [2.1. Java API](#21-java-api)
  - [2.2. Philosophy and Usage](#22-philosophy-and-usage)
...
In this project, we used principles discussed in lectures to **write a Java API** that another engineer could use to build an event-driven system.

This library is based on a heavily simplified version of the event streaming infrastructure [Apache Kafka](https://kafka.apache.org/), which you can read more about for your own interest. No understanding of Kafka is required.
